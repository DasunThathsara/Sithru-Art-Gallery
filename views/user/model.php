...
<form action="../../includes/register.inc.php" method="post">
  ...
  <div class="form-outline mb-4">
    ...
    <label class="form-label text-wrap">තරුණයෙක් / තරුණියක් විදිහට ඔබ තුල නිරූපණ ක්ෂේත්‍රය ගැන මොන වගේ අදහසක්ද තියෙන්නේ ?</label>
  </div>
  ...
  <div class="form-outline mb-4">
    ...
    <label class="form-label text-wrap">ඔබ නිරූපණයට අමතරව වෙනත් රැකියාවක් කරනවද ?</label>
  </div>
